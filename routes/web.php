...
//inline edit
Route::get('ShowData',[AdminController::class,'EditAllData'])->middleware('throttle:Limiter');
...
//Routes For Email And Adding New User
Route::get('AddUser',[AdminController::class,'UserForm'])->middleware(['auth' , 'role:admin']);
Route::post('AddUser',[AdminController::class,'AddUser']);
// Route::get('QueueEmail',[JobController::class,'EmailQueueJob']);
Route::get('SendEmail', [JobController::class,'SendEmail']);
